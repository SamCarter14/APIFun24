...
# in another python process, possibly running on a diff machine
#imagine you just trained an awesome MyRandomForestClassifier
#and now you need to save it for using your web app on a server later
#de/unpickle (object deserialization): loading a binary object representation 
#of an object from a file into a python object in program memory
#example: a web app that loads the trained model up for inference/prediction
# requests from clients
#
#lets pickle header and tree
